...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="http://localhost:8080/myspring/manager/manager.jsp">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="http://localhost:8080/myspring/manager/kechengguanli.jsp">课程管理</a><span class="crumb-step">&gt;</span><span>新增课程</span></div>
        </div>
