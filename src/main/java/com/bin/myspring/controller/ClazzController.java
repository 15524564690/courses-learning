...
public class ClazzController {
    ...
    public ResModel getAllClass(String categoryId, String directionId, String className) {
        List<Clazz> classList = clazzService.getClassList(categoryId, directionId, className);
        String code = "200";
        String message = "";
