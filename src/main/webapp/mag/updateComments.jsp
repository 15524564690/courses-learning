    ...
    <script>
        ...
        $(function () {
                ...
                $("#updateComments").click(function() {
                    alert($("#commentsform").serialize());
                    $.ajax({
                        type: "post",
                        url: "/action/comments/updateComments",
                        dataType: "json",
                        data:$("#commentsform").serialize(),
                        success: function (result) {
                            if(result.data == true)
                                window.location.href="pinglunguanli.jsp";
                        },
                        error: function (e) {
                        }
                    });
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form id="commentsform" method="post">
                    <table id="updateCommentsTab" class="insert-tab" width="100%">
                        <tbody>
                            <tr><th>评论ID</th>
                            ...
                            <tr><th>标题</th>
                                <td><input class="common-text required"
                                           name="titleid" size="50" value="${param.titleid}" type="text"></td></tr>
                            <tr><th>评论ID</th>
                                <td><input class="common-text required"
                                           name="commentid" size="50" value="${param.commentid}" type="text"></td></tr>
                            <tr><th>评论内容</th>
                                <td><input class="common-text required"
                                           name="content" size="50" value="${param.content}" type="text"></td></tr>
                            <tr><th>创建时间</th>
                                <td><input class="common-text required"
                            ...
                            <tr><th>操作</th>
                                <td><input style="margin:0 50px" class="btn btn6" onclick="history.go(-1)" value="返回" type="button">
                                    <a id="updateComments"  class="btn btn-success btn6 mr10">提交</a> </td></tr>
                            </tbody>
                    </table></form>
            </div>
        </div>
