    ...
    <script>
        ...
        $(function () {
                ...
                $("#updateD").click(function() {
                    alert($("#directionname").val());
                    $.ajax({
                        type: "GET",
                        url: "/action/direction/updateDirectionById?id="+${param.id},
                        dataType: "json",
                        data:{directionname:$("#directionname").val()},
                        success: function (result) {
                            if(result.data == true)
                                window.location.href="fangxiangguanli.jsp";
                        },
                        error: function (e) {
                        }
                    });
        ...
        <div class="crumb-wrap">
            <div class="crumb-list">
                <i class="icon-font"></i><a
                    ...
                    class="crumb-step">&gt;</span><span>修改方向</span>
            </div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form id="updateform" method="get">
                    ...
                    <table id="updateDirectionTab" class="insert-tab" width="100%">
                            <tbody>
                            <tr>
                                <th width="120"><i class="require-red">*</i>方向：</th>
                                <td><input class="common-text required" id="directionname"
                                           name="directionname" size="50" value="${param.directionname}" type="text"></td>
                            </tr>
                        <tr>
                                <th></th>
