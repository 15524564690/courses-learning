...
<head>
    ...
    <script>
        ...
        $(function () {
                ...
                $("#updateClazz").click(function() {
                    alert($("#clazzform").serialize());
                    $.ajax({
                        type: "post",
                        url: "/action/clazz/updateClazz",
                        dataType: "json",
        ...
        <div class="crumb-wrap">
            <div class="crumb-list">
                <i class="icon-font"></i><a
                    ...
                    href="${basePath}mag/pinglunguanli.jsp">评论管理</a><span
                    class="crumb-step">&gt;</span><span>修改评论信息</span>
            </div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form id="clazzform" method="post">
                    <table id="updateClazzTab" class="insert-tab" width="100%">
                        <tbody>
                            <tr><th>课程ID</th>
                                <td><input class="common-text required"
                                           name="id" size="50" value="${param.id}" type="text"></td></tr>
                            <tr><th>课程名</th>
                                <td><input class="common-text required"
                                           name="classname" size="50" value="${param.classname}" type="text"></td></tr>
                            <tr><th>课程描述</th>
                                <td><input class="common-text required"
                                           name="classdes" size="50" value="${param.classdes}" type="text"></td></tr>
                            <tr><th>上传时间</th>
                                <td><input class="common-text required"
                                           name="createtime" size="50" value="${param.createtime}" type="text"></td></tr>
                            <tr><th>更新时间</th>
                                <td><input class="common-text required"
                                           name="updatetime" size="50" value="${param.updatetime}" type="text"></td></tr>
                            <tr><th>上传者</th>
                                <td><input class="common-text required"
                                           name="userid" size="50" value="${param.userid}" type="text"></td></tr>
                            <tr><th>课程分类</th>
                                <td><input class="common-text required"
                                           name="categoryid" size="50" value="${param.categoryid}" type="text"></td></tr>
                            <tr><th>课程方向</th>
                                <td><input class="common-text required"
                                           name="directionid" size="50" value="${param.directionid}" type="text"></td></tr>
                            <tr><th>图片</th>
                                <td><input class="common-text required"
                                           name="pictureul" size="50" value="${param.pictureul}" type="text"></td></tr>
                            <tr><th>操作</th>
                                <td><input style="margin:0 50px" class="btn btn6" onclick="history.go(-1)" value="返回" type="button">
                                    <a id="updateClazz"  class="btn btn-success btn6 mr10">提交</a> </td></tr>
                            </tbody>
                    </table></form>
            </div>
        </div>
