        ...
        $(function () {
                ...
                $("#updateC").click(function() {
                   // alert($("#categoryname").val());
                    $.ajax({
                        type: "GET",
                        url: "/action/category/updateCategoryById?id="+${param.id},
                        dataType: "json",
                        data:{categoryname:$("#categoryname").val()},
                        success: function (result) {
                            if(result.data == true)
                                window.location.href="fenleiguanli.jsp";
                        },
                        error: function (e) {
                        }
                    });
        ...
        <div class="crumb-wrap">
            <div class="crumb-list">
                <i class="icon-font"></i><a
                    ...
                    href="${basePath}mag/fenleiguanli.jsp">分类管理</a><span
                    class="crumb-step">&gt;</span><span>修改分类</span>
            </div>
        </div>
            ...
            <div class="result-content">
                    ...
                    <table id="updateCategoryTab" class="insert-tab" width="100%">
                            ...
                            <tr>
                                ...
                                <td><input class="common-text required" id="categoryname"
                                           name="categoryname" size="50" value="${param.categoryname}" type="text"></td>
                            </tr>
                        <tr>
                                <th></th>
                            <td><input style="margin:0 50px" class="btn btn6" onclick="history.go(-1)" value="返回" type="button">
                                <a id="updateC"  class="btn btn-success btn6 mr10">提交</a> </td>
                        </tr>
                            </tbody>
                    </table>
            </div>
