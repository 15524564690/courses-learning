...
<div class="container clearfix">
            ...
            <ul class="sidebar-list">
                <li>
                    <a href="#"><i class="icon-font">&#xe003;</i>常用操作</a>
                     <ul class="sub-menu">
                        <li><a href="design.jsp"><i class="icon-font">&#xe008;</i>课程管理</a></li>
                        <li><a href="design.jsp"><i class="icon-font">&#xe005;</i>方向管理</a></li>
                        ...
                        <li><a href="design.jsp"><i class="icon-font">&#xe052;</i>章节管理</a></li>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="http://localhost:8080/myspring/manager/manager.jsp">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">课程管理</span></div>
        </div>
